...
<div class="container-fluid panel-formulario" >
    <div class="row">
           <div class="col-4 col-md-4 " id="table_acc">
                <button type="submit" class="btn btn-primary">Agregar Característica</button>
                <button type="submit" class="btn btn-primary">Modificar Característica</button>
                <button type="submit" class="btn btn-primary">Modificar Precargados</button>
                <button type="submit" class="btn btn-primary">Agregar Precargados</button>
            </div>
        <!-- lo de aca adentro debe ir en un js-->
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="col-3 col-md-12 "><div class="col-md-12" id="accordion" >
              ...
              <div class="collapse collapse-color container-fluid" id="collapseLentes">
                <p id="mostrarLentes">
                    <div class="checkbox">
                        <label><input type="checkbox" value="">Tipo Nuevo?</label>
                    </div>
