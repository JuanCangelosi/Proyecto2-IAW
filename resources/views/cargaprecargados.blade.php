...
<div class="container-fluid panel-formulario" >
    <div class="container-fluid col-md-offset-3">
           <div id="table_acc">
                <button type="submit" class="btn btn-primary btn_color1">Agregar Característica</button>
                <button type="submit" class="btn btn-primary btn_color3">Modificar Característica</button>
                <button type="submit" class="btn btn-primary btn_color4">Modificar Precargados</button>
            </div>
